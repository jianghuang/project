	...
	<body>
		...
		<div id="place">当前位置：[<a href="../index.jsp">首页</a>] - [员工信息更新]</div>
			<div id="thenew">
				...
				<div id="xinxigengxin">
					<p>
						<input type="button" onclick="window.location.href='updateEmployeeBirth.jsp'" value="更新出生日期" />
					</p>
					<p>&nbsp;</p>
					<p>
						<input type="button" onclick="window.location.href='updateEmployeePhone.jsp'" value="更新联系电话" />
					</p>
					<p>&nbsp;</p>
					<p>
						<input type="button" onclick="window.location.href='updateEmployeePlace.jsp'" value="更新家庭住址" />
					</p>
					<p>&nbsp;</p>
					<p>
						<input type="button" onclick="window.location.href='updateEmployeePassword.jsp'" value="更新系统口令" />
					</p>
					<p>&nbsp;</p>
				</div>
			</div>
