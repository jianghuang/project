...
<%@page import="com.jh.dao.MessageDAO"%>
<%@page import="com.jh.factory.MessageDAOFactory"%>
<%@page import="com.jh.util.Page"%>
<%@page import="com.jh.util.PageUtil"%>
<%@page import="com.jh.bean.Message"%>
		...
		<div id="bookmunu">
			<div class="jsmenu" id="jsmenu">
				<ul>
				  ...
				  <li class="normal"><a urn="jsmenu3" rel="conmenu" href="page/statusRecognise.jsp">身份识别</a></li>
				</ul>
			</div>
			<div id="conmenu"></div>
		</div>
				...
				<div id="employee">
					<c:choose>
						...
						<c:otherwise>
							...
							<p>
								&nbsp;&nbsp;<input type="button" onclick="window.location.href='page/updateEmployee.jsp'" value="更新个人信息" />
							</p>
						</c:otherwise>
					</c:choose>
					<c:if test="${sessionScope.employee.lead}">
						<p>&nbsp;</p>
						<p>&nbsp;&nbsp;
							<a href="SelectAllEmployee">查看所有员工信息</a>
						</p>
					</c:if>
				</div>
			</div>
