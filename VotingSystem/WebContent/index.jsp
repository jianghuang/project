	      ...
	      <tr>
	        <td height="37" align="left" valign="top" background="images/menu.jpg">
		        ...
		        <div style="padding-left:42px; padding-top:10px">
		        	...
		        	<a href="showVoteByChannel.action?channelID=3" class="style2" style="text-decoration:none ">中超</a>
		        	<img src="images/spacer.gif" width="33" height="1">
		        	<a href="showVoteByChannel.action?channelID=4" class="style2" style="text-decoration:none ">西甲</a>
